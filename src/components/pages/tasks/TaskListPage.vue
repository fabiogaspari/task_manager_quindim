    ...
    <div class="flex flex-grow">
        <div class="flex justify-center content-start w-full h-full q-gutter-sm pb-20">
            ...
            <div class="w-full h-full bg-primary-001 p-4 rounded-default grid gap-y-4">
                ...
                <CardTaskDefault
                    :task="{ id: 1, title: 'teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste ', description: 'teste', status: { id: 1, name: 'teste', description: 'teste', bg_color: 'bg-tertiary-005', font_color: 'text-black' }, expiration_date: new Date(), created_at: new Date(), updated_at: new Date() }">
